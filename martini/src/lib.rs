//! Based on https://github.com/hopey-dishwasher/termpix/blob/master/src/lib.rs
...
pub fn print_image(img: &image::DynamicImage, true_colour: bool, width: u32, height: u32, prefix: &str) {
